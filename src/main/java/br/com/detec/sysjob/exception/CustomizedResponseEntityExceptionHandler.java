...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(ProfileNotFoundEntityException.class)
	public final ResponseEntity<Object> handleProfileNotFoundException(ProfileNotFoundEntityException ex,
			WebRequest request) {
		ExceptionResponse exResponse = new ExceptionResponse(new Date(), ex.getMessage(),
				request.getDescription(false));
